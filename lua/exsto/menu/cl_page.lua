...
function page:CreateFlag()
	--[[local sender = exsto.CreateSender( "ExCreateFlag" )
		sender:AddString( self:GetID() )
		sender:AddString( "Automatically generated by: " .. self:GetTitle() )
	sender:Send()]]
end
